...
// package 는 클래스 외부에서 선언 
// package : 클래스를 담는 그릇이다 
// 패키지를 선언하지 않고 클래스를 생성 할 경우 : default 패키지에 저장.  class의 위치는 src
// 같은 패키지 내에서는 동일한 이름의 클래스가 존재 할 수 없다 
...
public class Package_1 {
	...
	public static void main(String[] args) {
		...
		Scanner sca = new Scanner(System.in);  // 같은패키지에 존재하지 않는 클래스를 사용할떄 
		//클래스  객체   new   생성자   ( 매개변수)
