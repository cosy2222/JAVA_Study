...
public class System_GetProperty {
	...
	public static void main(String[] args) {
		...
		System.out.println(System.getProperty("user.dir"));	// 현재작업 디렉토리를 출력 
		...
		System.out.println(System.getProperty("java.home"));	// 홈폴더
		System.out.println(System.getProperty("os.name"));		// os정보
		System.out.println(System.getProperty("os.arch"));		// os아키텍쳐
		System.out.println(System.getProperty("os.version"));	// os버젼
